...
public class form1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(tfExpresionRegular, new org.netbeans.lib.awtextra.AbsoluteConstraints(366, 94, 180, 30));

        jLabel1.setFont(new java.awt.Font("Tw Cen MT Condensed Extra Bold", 0, 18)); // NOI18N
        jLabel1.setText("Ingrese la expresión regular");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(356, 54, 230, 30));

        btCargarER.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        btCargarER.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/Refresh_64px.png"))); // NOI18N
        btCargarER.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btCargarERActionPerformed(evt);
            }
        });
        getContentPane().add(btCargarER, new org.netbeans.lib.awtextra.AbsoluteConstraints(156, 124, 110, 80));

        btVerAutomata.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        btVerAutomata.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/Eye_64px.png"))); // NOI18N
        btVerAutomata.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btVerAutomataActionPerformed(evt);
            }
        });
        getContentPane().add(btVerAutomata, new org.netbeans.lib.awtextra.AbsoluteConstraints(646, 124, 110, 90));
